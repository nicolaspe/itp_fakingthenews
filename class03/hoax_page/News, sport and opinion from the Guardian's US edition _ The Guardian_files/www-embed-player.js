...
Rb.prototype.add=function(a,b){var c=Tb.get();c.set(a,b);this.g?this.g.next=c:this.b=c;this.g=c};
...
Sb.prototype.reset=function(){this.next=this.scope=this.b=null};function Ub(a,b){Vb||Wb();Xb||(Vb(),Xb=!0);Yb.add(a,b)}
...
;var We={log_event:"events",log_interaction:"interactions"},Xe=Object.create(null);Xe.log_event="GENERIC_EVENT_LOGGING";Xe.log_interaction="INTERACTION_LOGGING";var Ye={},Ze={},$e=0,W=u("ytLoggingTransportLogPayloadsQueue_")||{};t("ytLoggingTransportLogPayloadsQueue_",W,void 0);var af=u("ytLoggingTransportTokensToCttTargetIds_")||{};t("ytLoggingTransportTokensToCttTargetIds_",af,void 0);var bf=u("ytLoggingTransportDispatchedStats_")||{};t("ytLoggingTransportDispatchedStats_",bf,void 0);
t("ytytLoggingTransportCapturedTime_",u("ytLoggingTransportCapturedTime_")||{},void 0);function cf(a,b){Ze[a.endpoint]=b;if(a.T){var c=a.T;var d={};c.videoId?d.videoId=c.videoId:c.playlistId&&(d.playlistId=c.playlistId);af[a.T.token]=d;c=df(a.endpoint,a.T.token)}else c=df(a.endpoint);c.push(a.payload);c.length>=(Number(T("web_logging_max_batch")||0)||20)?ef():ff()}
